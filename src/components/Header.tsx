      ...
      <div className="relative">
        ...
        {menuVisible && (
          <div className="absolute top-full right-0 mt-4 bg-white rounded ">
            <ul>
              <li className="px-5 py-2 hover:bg-rose-200 bg-rose-700 text-black font-medium">Ver perfil</li>
              <hr />
              <li className="px-4 py-2 hover:bg-rose-200 bg-rose-700 text-black font-medium">Cambiar contraseña</li>
              <hr />
              <li className="px-4 py-2 hover:bg-rose-200 bg-rose-700 text-black font-medium">Ajustes</li>
              <hr />
              <li className="px-4 py-2 hover:bg-rose-200 bg-rose-700 text-black font-medium" onClick={() => useLogout()}>
                Cerrar sesión
              </li>
            </ul>
          </div>
